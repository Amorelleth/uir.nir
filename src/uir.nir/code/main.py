...
epoch = 30000       # Number of iterations / generations / epochs
pop_size = 30       # Populations size
...
lb4 = [-5] * problemSize
ub4 = [10] * problemSize
# No need the keyword "problem_size"
md4 = BasePSO(obj_func, lb4, ub4, verbose, epoch, pop_size)
...
md6 = BasePSO(obj_func, lb4, ub4, verbose, epoch, pop_size,
              batch_idea=batchIdea, batch_size=batchSize)  # Remember the keywords
